...
export async function GET(request: NextRequest) {
    try {
        ...
        const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/media-studio/resize-image`, {
            method: 'GET',
            headers: {
        ...
        return NextResponse.json({ error: 'Failed to fetch image presets' }, { status: 500 });
    }
}
