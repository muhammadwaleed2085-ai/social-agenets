...
/**
 * POST /api/v1/meta-ads/campaigns/[campaignId]/duplicate
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/meta-ads/campaigns/${campaignId}/duplicate`, {
            method: 'POST',
            headers: {
