...
/**
 * POST /api/v1/meta-ads/campaigns/[campaignId]/unarchive
...
export async function POST(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/meta-ads/campaigns/${campaignId}/unarchive`, {
            method: 'POST',
            headers: {
